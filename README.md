...
<body>
    ...
    <div id="tela-principal">
        <header>
            <div class="header-top">
                <div class="logo" onclick="window.location.href=window.location.pathname">⚡ XR SPORTS</div>
    ...
    <div id="tela-digital">
        <h2 style="text-align: center; color: var(--neon); font-style: italic; margin-bottom: 10px;">⚡ XR SPORTS</h2>
    ...
    <script>
        const API_KEY = "2e347c2a41f0f96c0b72ef0cfa6f2b33"; 
        ...
        function fazerLogin() {
            if(document.getElementById('user').value === 'RickAlves76' && document.getElementById('pass').value === 'admin') {
                ...
                document.getElementById('user').value = ''; document.getElementById('pass').value = ''; mostrarToast("Login efetuado com sucesso!");
        ...
        function enviarParaAdmin() {
            ...
            let pacoteDados = { p: codigoPIN, n: "", v: valorDep, o: parseFloat(oddGeral), j: carrinho };
        ...
        function gerarBilheteValidado() {
            ...
            try {
                ...
                window.location.href = window.location.origin + window.location.pathname + "?b=" + btoa(encodeURIComponent(JSON.stringify(dados))) + "&v=1";
